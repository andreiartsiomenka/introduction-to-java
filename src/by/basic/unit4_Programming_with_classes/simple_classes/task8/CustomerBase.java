...
public class CustomerBase {
	...
	public CustomerBase(String customersGroup, ArrayList<Customer> base) {
	...
	void addCustomer(String lastName, String firstName, String patronymic, String address, BigInteger cardNumber,
