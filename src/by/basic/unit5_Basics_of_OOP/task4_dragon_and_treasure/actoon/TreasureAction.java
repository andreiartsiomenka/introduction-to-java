package by.basic.unit5_basics_of_oop.task4_dragon_and_treasure.actoon;
...
import by.basic.unit5_basics_of_oop.task4_dragon_and_treasure.DragonAndTreasureMain;
import by.basic.unit5_basics_of_oop.task4_dragon_and_treasure.entity.*;
...
public class TreasureAction {
    ...
    public List<Treasure> fillCaveWithTreasures(int numberOfTreasure) {
        List<Treasure> treasures = new ArrayList<>();
        try {
            FileReader fileReader = new FileReader("src/by/basic/unit5_basics_of_oop/task4_dragon_and_treasure/data/treasures_list.txt");
